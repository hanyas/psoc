...
ppo_reward = -1.0 * np.load(str(env_path) + "ppo_" + str(env_name) + ".npy")[:, 1:].T
trpo_reward = -1.0 * np.load(str(env_path) + "trpo_" + str(env_name) + ".npy")[:, 1:].T
smc_reward = -1.0 * np.load(str(env_path) + "smc_" + str(env_name) + ".npy")[:, ::5]
csmc_reward = -1.0 * np.load(str(env_path) + "csmc_" + str(env_name) + ".npy")[:, ::5]
...
iters = np.linspace(0, 20, 21, dtype=int)
